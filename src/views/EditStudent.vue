  ...
  created() {
    ...
    if (this.student) {
      ...
      this.form = {
        ...
        enrollmentDate: this.student.enrollment_date || this.student.enrollmentDate,
        gpa: this.student.gpa,
        image: this.student.image || 'std-01.jpeg'
      }
    }
  },
  methods: {
    async handleSubmit() {
      try {
        await mutations.updateStudent(this.student.id, this.form)
